	...
	function Canvas(){
		...
		this.createLineGraph = function(dataStack){
			...
			function plotData(dataSet,sections,finalY) {
				...
				var finalX = sections*xScale;
				context.beginPath();
				context.moveTo(startX,startY);
				for(var i=1;i<sections;i++){
					var endX = i*xScale;
					var endY = dataSet[i]+2;
					displayLineGraphSlowly(context,startX,startY,endX,endY,i,finalX,finalY);
				};
				
			};

			
				var displayLineGraphSlowly = function(context,startX,starY,endX,endY,i,finalX,finalY){
					console.log('haha');
