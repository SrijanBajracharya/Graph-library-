;(function(){
	...
	function DataDiv () {
		...
		this.createForm = function(){
			...
			this.label2.style.margin = '10px 20px 10px 50px';
	...
	function Choose(){
		...
		this.fileUpload.style.marginLeft = '20px'
	...
	function DataHandler(){
		...
		var displayInTable = function(data){
			...
			btnEdit.style.background = 'url(images/btnb.png)';
			...
			btnDelete.style.background = 'url(images/btnb.png)';
