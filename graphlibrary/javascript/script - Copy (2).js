		...
		var displayInTable = function(data){
			...
			btnDelete.onclick = (function(){
				return function(){
					...
					/*var that = this;
					this.deleteConfirmDiv = document.createElement('div');
					this.deleteConfirmDiv.style.position = 'absolute';
					this.deleteConfirmDiv.style.height = '300px';
					this.deleteConfirmDiv.style.width = '300px';
					this.deleteConfirmDiv.style.top = '500px';
					this.deleteConfirmDiv.style.left = '600px';	
					console.log(this.deleteConfirmDiv);	
					mainDiv.appendChild(this.deleteConfirmDiv);	*/																	
				};
			})();
